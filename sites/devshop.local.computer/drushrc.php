...
$options['db_host'] = 'database';
$options['db_port'] = '3306';
$options['db_passwd'] = 'HwGy6i6tHT';
$options['db_name'] = 'devshoplocalcomp';
$options['db_user'] = 'devshoplocalcomp';
...
@include_once('/var/aegir/devmaster-1.x/sites/devshop.local.computer/local.drushrc.php');
